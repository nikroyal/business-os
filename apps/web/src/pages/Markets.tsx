  ...
  return (
    <div style={{ animation: 'fadeIn 0.25s ease-out', textAlign: 'left' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: '2rem', marginBottom: '2rem' }}>
        ...
        {/* Left Side: Overnight Feed */}
        <div className="card-custom" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.2rem', minHeight: '400px' }}>
      ...
      {/* Row 2: Visual Sector Rotation & Breadth Gauges */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
        ...
        <div className="card-custom" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ 
            ...
            {/* Top Left: Improvers */}
            <div style={{ background: '#141722', border: '1px solid #4285f4', padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #222', paddingBottom: '0.25rem', marginBottom: '0.25rem' }}>
                ...
                <span style={{ fontSize: '0.55rem', color: 'var(--text-secondary)' }}>RS &lt; 1, M &gt; 0</span>
              </div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                {sectorsByQuadrant.Improver.map(s => (
                  <span key={s.sectorId} className="badge-active" style={{ background: '#1c2236', border: '1px solid #2b395e', color: '#82b1ff', fontSize: '0.7rem', padding: '2px 6px' }}>
                    {s.name}
                  </span>
                ))}
              </div>
            ...
            {/* Top Right: Leaders */}
            <div style={{ background: '#121e17', border: '1px solid #34a853', padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #222', paddingBottom: '0.25rem', marginBottom: '0.25rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                {sectorsByQuadrant.Leader.map(s => (
                  <span key={s.sectorId} className="badge-active" style={{ background: '#1a2e20', border: '1px solid #2a4c33', color: '#81c784', fontSize: '0.7rem', padding: '2px 6px' }}>
                    {s.name}
                  </span>
                ))}
              </div>
            ...
            <div style={{ background: '#241416', border: '1px solid #ea4335', padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #222', paddingBottom: '0.25rem', marginBottom: '0.25rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                {sectorsByQuadrant.Laggard.map(s => (
                  <span key={s.sectorId} className="badge-active" style={{ background: '#3b1c1e', border: '1px solid #632a2c', color: '#e57373', fontSize: '0.7rem', padding: '2px 6px' }}>
                    {s.name}
                  </span>
                ))}
              </div>
            ...
            <div style={{ background: '#241a12', border: '1px solid #fbbc05', padding: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #222', paddingBottom: '0.25rem', marginBottom: '0.25rem' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
                {sectorsByQuadrant.Deteriorator.map(s => (
                  <span key={s.sectorId} className="badge-active" style={{ background: '#362816', border: '1px solid #5a4220', color: '#ffd54f', fontSize: '0.7rem', padding: '2px 6px' }}>
                    {s.name}
                  </span>
                ))}
              </div>
      ...
      {/* Row 3: "Why This Matters To Me" Panel & News Brief */}
      <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: '2rem', marginBottom: '2rem' }}>
        ...
        <div className="card-custom" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ background: '#111', padding: '1rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                <span style={{ fontSize: '0.7rem', color: 'var(--text-secondary)', display: 'block' }}>PORTFOLIO EXPOSURES TOUCHED</span>
                <strong style={{ fontSize: '1.15rem' }}>{data.portfolioImpact.affectedHoldingsCount} of your active assets</strong>
              </div>
              <div>
                <span style={{ fontSize: '0.7rem', color: 'var(--text-secondary)', display: 'block' }}>ALLOCATION RISK SCORE ADJUSTMENT</span>
                <strong style={{ fontSize: '1.15rem', color: data.portfolioImpact.allocationRiskDelta > 0 ? 'var(--color-warning-text)' : 'var(--color-success-text)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              {data.portfolioImpact.riskHighlights.length > 0 ? (
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--color-success-text)' }}>✓ No high-priority risk warnings triggered from active allocations.</span>
              )}
              ...
              {data.portfolioImpact.opportunityHighlights.length > 0 ? (
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>No active thematic opportunity spikes generated from holdings structure.</span>
              )}
            </div>
      ...
      {/* Row 4: Regime Transition History */}
      <div className="card-custom" style={{ padding: '1.5rem', marginBottom: '3rem' }}>
